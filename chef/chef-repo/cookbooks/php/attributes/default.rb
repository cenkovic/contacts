...
when 'rhel', 'fedora'
  ...
  if node['platform_version'].to_f < 6
    default['php']['packages'] = %w{ php53 php53-devel php53-cli php-pear php5-gd}
  else
    default['php']['packages'] = %w{ php php-devel php-cli php-pear php5-gd}
  end
when 'debian'
  ...
  default['php']['packages']      = %w{ php5-cgi php5 php5-dev php5-cli php-pear php5-gd}
when 'suse'
  default['php']['conf_dir']      = '/etc/php5/cli'
  default['php']['ext_conf_dir']  = '/etc/php5/conf.d'
  default['php']['fpm_user']      = 'wwwrun'
  default['php']['fpm_group']     = 'www'
  default['php']['packages']      = %w{ apache2-mod_php5 php5-pear php5-gd}
  lib_dir = node['kernel']['machine'] =~ /x86_64/ ? 'lib64' : 'lib'
when 'windows'
